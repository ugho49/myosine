<div id="maildecontact" style="background-color:white;font-family: arial,sans-serif;">
    ...
    <div id="contenuemaildecontact" style="padding: 5px;">
        <h3 style="text-align: center; color:red; font-weight:bold; line-height: inherit;">
            - Mot de passe oublié -
        </h3>
        <p style="line-height: inherit; font-size: 100%;">
            Nous venons de vous créer un nouveau mot de passe aléatoire. Il est IMPORTANT de le changer !!!!<br>
            Veuillez trouver ci-joint votre nouveau mot de passe : <br>
            (Pensez à le conserver précieusement.)
        </p>
        <h4 style="line-height: inherit; font-weight:bold; color: black;">
            <u>Nouveau mot de passe :</u> {{ $newPassword }}
        </h4>
        <p style="line-height: inherit; font-size: 100%;">
            Cordialement,<br>
            Le site web Myosine.
